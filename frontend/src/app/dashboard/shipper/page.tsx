  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        // const response = await fetch('http://localhost:5000/api/shippers/dashboard', {
        //   headers: {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-lg font-medium text-gray-900">{stats.activeLoads}</div>
                  </dd>
                </dl>
              </div>
            </div>
          ...
          <div className="bg-gray-50 px-4 py-4 sm:px-6">
            <div className="text-sm">
              <Link href="/dashboard/shipper/loads" className="font-medium text-blue-600 hover:text-blue-500">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-lg font-medium text-gray-900">{stats.pendingBids}</div>
                  </dd>
                </dl>
              </div>
            </div>
          ...
          <div className="bg-gray-50 px-4 py-4 sm:px-6">
            <div className="text-sm">
              <Link href="/dashboard/shipper/bids" className="font-medium text-blue-600 hover:text-blue-500">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-lg font-medium text-gray-900">{stats.inTransit}</div>
                  </dd>
                </dl>
              </div>
            </div>
          ...
          <div className="bg-gray-50 px-4 py-4 sm:px-6">
            <div className="text-sm">
              <Link href="/dashboard/shipper/tracking" className="font-medium text-blue-600 hover:text-blue-500">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-4 py-4 sm:px-6">
            <div className="text-sm">
              <Link href="/dashboard/shipper/loads?status=completed" className="font-medium text-blue-600 hover:text-blue-500">
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-md">
        <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
          <h3 className="text-lg leading-6 font-medium text-gray-900">Recent Loads</h3>
          <Link href="/dashboard/shipper/loads" className="text-sm font-medium text-blue-600 hover:text-blue-500">
            View all
          </Link>
        </div>
        <ul className="divide-y divide-gray-200">
          {recentLoads.map((load: any) => (
            <li key={load.id}>
              <Link href={`/dashboard/shipper/loads/${load.id}`} className="block hover:bg-gray-50">
                <div className="px-4 py-4 sm:px-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <p className="text-sm font-medium text-blue-600 truncate">{load.title}</p>
                      <div className="ml-2 flex-shrink-0 flex">
                        <p className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                          ${load.status === 'In Transit' ? 'bg-yellow-100 text-yellow-800' : 
                            load.status === 'Bidding' ? 'bg-blue-100 text-blue-800' : 
                            load.status === 'Posted' ? 'bg-green-100 text-green-800' : 
                  ...
                  <div className="mt-2 sm:flex sm:justify-between">
                    ...
                    <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                      ...
                      <p>
                        Pickup on <time dateTime={load.pickupDate}>{new Date(load.pickupDate).toLocaleDateString()}</time>
                      </p>
                    </div>
                  </div>
                </div>
